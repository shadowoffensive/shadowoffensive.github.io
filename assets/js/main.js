...
function scrollActive(){
    ...
    sections.forEach(current => {
        ...
        if(scrollY >  sectionTop && scrollY <= sectionTop + sectionHeight){
            document.querySelector('.nav__menu a[href*=' + sectoinId + ']').classList.add('active-link')
        }else{
            document.querySelector('.nav__menu a[href*=' + sectoinId + ']').classList.remove('active-link')
        }
    })
}
